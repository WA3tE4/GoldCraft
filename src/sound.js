...
class SoundEngine {
  ...
  play(name) {
    switch (name) {
      ...
      case "shoot":  this.tone(880, 0.05, "square", 0.16, 220); this.noise(0.04, 0.14, 2600); break;
      case "laser":  this.tone(1200, 0.09, "sawtooth", 0.16, 320); break;
      case "explosion": this.noise(0.4, 0.6, 600); this.tone(90, 0.4, "sawtooth", 0.32, 40); break;
      case "fuse":   this.tone(1400, 0.03, "square", 0.08, 1700); break;
      case "power":  this.tone(523, 0.09, "sine", 0.22); this.tone(659, 0.09, "sine", 0.2, null, 0.07); this.tone(784, 0.12, "sine", 0.2, null, 0.14); this.tone(1046, 0.14, "sine", 0.18, null, 0.21); break;
    }
  }
}
